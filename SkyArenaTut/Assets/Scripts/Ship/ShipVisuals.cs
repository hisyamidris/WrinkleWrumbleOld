...
public class ShipVisuals : ShipBase
{
	...
	public void SetTeamColors( Team team )
	{
		...
		if( team == Team.Blue )
		{
			VisualParent.Find( "Ship_Player_07" ).renderer.material.color = Color.blue;
			VisualParent.Find( "Ship_Player_07" ).renderer.material.SetColor( "_Color1", new Color( 0.5f, 0.5f, 1f ) );
			...
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorBottom", Color.blue );
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorTop", new Color( 0.5f, 0.5f, 1f ) );
		}
		else if( team == Team.Red )
		{
			VisualParent.Find( "Ship_Player_07" ).renderer.material.color = Color.red;
			VisualParent.Find( "Ship_Player_07" ).renderer.material.SetColor( "_Color1", new Color( 1f, 0.5f, 0.5f ) );
			...
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorBottom", Color.red );
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorTop", new Color( 1f, 0.5f, 0.5f ) );
		}
		else
		{
			VisualParent.Find( "Ship_Player_07" ).renderer.material.color = new Color( 0.05f, 0.05f, 0.05f );
			VisualParent.Find( "Ship_Player_07" ).renderer.material.SetColor( "_Color1", new Color( 0.5f, 0.5f, 0.5f ) );
			VisualParent.Find( "FX_Exaust" ).GetComponent<ParticleSystem>().startColor = Color.red;
			VisualParent.Find( "FX_Exaust" ).Find( "Particle System Glow" ).GetComponent<ParticleSystem>().startColor = Color.yellow;
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorBottom", Color.yellow );
			VisualParent.Find( "FX_Exaust" ).Find( "Trail" ).renderer.material.SetColor( "_ColorTop", new Color( 1f, 1f, 0.8f ) );
		}
	}
